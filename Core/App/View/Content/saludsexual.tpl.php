        ...
        <div class="bloque-uno-ss">
            <div class="bloque-fr2">
                <div class="txt-intro-fr2">
                    <p class="cabecera-uno-ss">¿Qué es la salud sexual?</p>
                    <p class="cuerpo-texto-uno-ss">
                        La salud sexual es el bienestar físico, mental y social en relación con la sexualidad, para
                        lograrlo
                        es importante que los derechos sexuales de todas las personas se respeten, protejan y se ejerzan
                        plenamente.
                    </p>
                </div>
            ...
            <div class="bloque-fr2">
                ...
                <div class="txt-intro-fr2">
                    ...
                    <p class="cuerpo-texto">
                        La salud sexual no se logra solo con un elemento, imagina que es una receta, lograr un gran
                        platillo
                        requiere de varios elementos para lograr lo que se busca, lo mismo pasa con la salud sexual, es
                        un
