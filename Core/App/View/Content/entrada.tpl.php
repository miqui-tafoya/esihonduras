...
<div id="main">
    ...
    <div class="contenedor-publica">
        ...
        <div class="bloque-entrada">
             <div class="nombre-publicado"> <p><?php echo $entrada['entradas_timestamp']; ?></p></div>
           
           <div class="img-entrada">
           <img src="<?php echo URL_PUBLIC . 'recursos/entradas/' . $entrada['portada']; ?>" alt=""> 
           </div>
          
            <div><p class="cabecera-dos-publica"><?php echo $entrada['entradas_titulo']; ?></p> </div>
         
            <div> <p class="cuerpo-texto"><?php echo $entrada['cuerpo']; ?></p></div>
        </div>
