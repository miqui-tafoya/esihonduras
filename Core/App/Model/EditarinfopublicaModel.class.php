...
class EditarinfopublicaModel extends Model {
    ...
    private function getCategoria() {
        ...
        $data = $this->db->dbCall('all', false, $columnas, 'tb_categorias', ['tipo' => 'publica'], ['DESC' => 'tb_categorias_id']);
        return $data;
    }
    ...
    public function setIds() {
        $cols = ['tb_entradas_id'];
        $data = $this->db->dbCall('all', false, $cols, 'tb_entradas', ['tipo' => 'publica']);
        $temp = [];
