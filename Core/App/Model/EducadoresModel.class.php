...
class EducadoresModel extends Model {
    ...
    public function getActividades() {
        ...
        <p> La Educación Sexual Integral (ESI) es un proceso educativo que aborda la sexualidad humana en todas sus dimensiones —cognitiva, emocional, física y social— desde una perspectiva de derechos humanos, igualdad de género y evidencia científica.</br></br>
        Según la UNESCO, la educación integral en sexualidad tiene cinco veces más probabilidades de tener éxito en la prevención de embarazos adolescentes y enfermedades de transmisión sexual cuando presta atención explícita a los temas de género y poder.</br></br>
        En México, la ESI busca capacitar a niñas, niños y jóvenes con conocimientos, habilidades, actitudes y valores para cuidar su salud, bienestar y dignidad; establecer relaciones respetuosas; analizar sus decisiones y proteger sus derechos.</br></br>
    ...
    ',
        ...
        <p>La sexualidad es una dimensión central del ser humano y está presente en todas las etapas de la vida. Una educación sexual integral contribuye a prevenir embarazos no planificados, infecciones de transmisión sexual y violencia sexual o de género.</br></br>
        Además, la ESI promueve el respeto, la equidad y la convivencia saludable, permitiendo desmontar mitos, prejuicios y estereotipos relacionados con la sexualidad y el género.</br></br>
        <strong>Fuentes:</strong> UNESCO (2023), Agencia Presentes (2023), SIPINNA (2024).</p>
    ',
            3 => '
    ...
    ',
        ...
        <p class="cuerpo-texto">La ESI no es un contenido adicional, sino una herramienta fundamental para formar personas libres, responsables y respetuosas. Al incorporar la ESI en el aula, las y los docentes promueven una sociedad más justa, equitativa e inclusiva.</br></br>
        La Educación Sexual Integral (ESI) es una herramienta educativa clave para la formación de ciudadanías críticas, respetuosas y libres de violencia. Esta guía amplía los contenidos previos, integrando nuevas perspectivas sobre adolescencia, diversidad sexual, uso de herramientas digitales y trabajo con familias. Está diseñada para docentes que buscan fortalecer su práctica desde un enfoque integral, laico, científico y de derechos humanos.</br></br>
        <strong>Fuentes:</strong> UNESCO (2023), SEP (2024), Fondo de Población de las Naciones Unidas (UNFPA, 2023), UNICEF (2023).</p>
    ',
            6 => '
        ...
        Es esencial promover la reflexión crítica sobre la presión social, el consentimiento, las masculinidades, el autocuidado y la toma de decisiones informadas. La ESI fomenta la construcción de una identidad positiva y relaciones basadas en el respeto.</br></br>
        <strong>Fuentes:</strong> UNFPA (2023) "Adolescentes y Juventudes", OMS (2022) "Salud sexual y reproductiva en la adolescencia", SEP (2024).</p>
    ',
            7 => '
        ...
        El rol docente incluye visibilizar la diversidad, evitar el lenguaje discriminatorio y fomentar el respeto. Es fundamental enseñar sobre identidad de género, orientación sexual, expresión de género y derechos humanos.</br></br>
        <strong>Fuentes:</strong> Consejo Nacional para Prevenir la Discriminación (CONAPRED, 2024), UNESCO (2023), ILSB (2024).</p>
    ',
            8 => '
        <h2 class="cabecera-one">8. Herramientas digitales y ESI</p>
        <p>Las tecnologías digitales atraviesan la vida cotidiana de niñas, niños y adolescentes. La ESI debe incorporar el uso responsable, crítico y ético de estas herramientas, abordando temas como el sexting, la privacidad digital, la exposición de imágenes, el consentimiento en entornos virtuales y la ciber-violencia.</br></br>
        Promover la ciudadanía digital implica enseñar a reflexionar sobre los límites, los riesgos y las oportunidades del entorno digital para las relaciones y la sexualidad.</br></br>
        <strong>Fuentes:</strong> UNICEF (2023) "Seguridad digital y adolescencia", INMUJERES (2024) "Ciberacoso y género", Red por los Derechos de la Infancia en México (REDIM, 2023).</p>
    ',
            9 => '
        ...
        <strong>Estrategias sugeridas:</strong></p>
        <ul>
    ...
    ',
        ...
        <p>La ESI es también una herramienta para construir ciudadanía y promover la equidad social. Al abordar temas de poder, género, consentimiento y derechos, la escuela se convierte en un espacio que forma personas capaces de participar activamente en la sociedad y defender la igualdad.</br></br>
        La ESI contribuye al desarrollo integral de las y los estudiantes, promueve relaciones basadas en el respeto y fortalece las competencias socioemocionales. Implementarla de forma sistemática, sensible y adaptada al contexto escolar genera comunidades más sanas, igualitarias y libres de violencia.</br></br>
    ...
    ',
            13 => '
        <h2 class="cabecera-one">13. Guía para la intervención en temas relacionados con sexualidad</h2>
        ...
        <ol>
            <li>1. Brindar información desde la educación no es un delito, es un derecho que tienen las adolescencias a recibir información sobre sus derechos sexuales y reproductivos.</li></br>
            <li>2. Los derechos sexuales y reproductivos son <strong>DERECHOS HUMANOS</strong>.</li></br>
            <li>3. Apostemos por diversificar las formas en las que estamos escuchando y hablando con las adolescencias; una comunicación informal no es sinónimo de mala comunicación, si tiene un objetivo y un propósito se logrará la comunicación efectiva.</li></br>
            <li>4. Al acompañar, recuerda brindar información de forma clara, amigable y respetuosa.</li></br>
            <li>5. Si como mentor(a) identificas que alguno de los temas que el alumnado quiere comentar contigo te hace sentir enojado(a), triste, confundido(a) o te lleva a cuestionarte, es funcional trabajarlo en tu espacio de terapia personal para brindar un acompañamiento más objetivo.</li></br>
            <li>6. Actualizarse constantemente es sumamente importante.</li></br>
            <li>7. Evitar a toda costa los juicios y prejuicios ayuda mucho a un mejor acompañamiento. Si al acompañar te genera un juicio, entonces detente.</li></br>
            <li>8. Intervenir con naturalidad al momento de tratar temas relacionados con sexualidad. Recuerda que la comunicación no verbal también comunica.</li></br>
            <li>9. Si la información que te piden o el acompañamiento está fuera de tu alcance, canaliza y da seguimiento.</li></br>
            <li>10.La educación integral en sexualidad es una herramienta para prevenir.</li>
        </ol></br></br>
    '
        ];
        return $data;
