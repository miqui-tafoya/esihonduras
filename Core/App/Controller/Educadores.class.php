...
class Educadores extends Render {
    ...
    public function GET_AJAX_handler() {
        ...
        $slides = [
            1 => '
        <h2>1. ¿Qué es la Educación Sexual Integral (ESI)?</h2>
        <p>La Educación Sexual Integral (ESI) es un proceso educativo que aborda la sexualidad humana en todas sus dimensiones —cognitiva, emocional, física y social— desde una perspectiva de derechos humanos, igualdad de género y evidencia científica.</p>
    ...
    ',
            2 => '
        <h2>2. Importancia de la ESI en las escuelas</h2>
    ...
    ',
            3 => '
        <h2>3. Contenidos clave para docentes</h2>
        <ul>
    ...
    ',
            4 => '
        <h2>4. Orientaciones prácticas para el aula</h2>
        <ul>
    ...
    ',
            6 => '
        <h2>6. La adolescencia y la ESI</h2>
    ...
    ',
            7 => '
        <h2>7. Diversidad sexual y de género</h2>
    ...
    ',
            8 => '
        <h2>8. Herramientas digitales y ESI</h2>
    ...
    ',
            9 => '
        <h2>9. Trabajo con familias desde la ESI</h2>
    ...
    ',
            10 => '
        <h2>10. ESI, equidad y construcción de ciudadanía</h2>
    ...
    ',
            11 => '
        <h2>11. Los Cinco Ejes Fundamentales (Enfoque Común Regional)</h2>
        <ul>
    ...
    ',
            12 => '
        <h2>12. Profundización en marcos legales específicos y desafíos (Honduras)</h2>
    ...
    ',
            13 => '
        <h2>13. Guía para la intervención en temas relacionados con sexualidad</h2>
